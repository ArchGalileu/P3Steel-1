 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 319.474, 320.813, 796.01, 559.5 } 
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 5000, 2000, 1000, 1500 }
 ...
 *    (0,0)
 */
#define X_PROBE_OFFSET_FROM_EXTRUDER 25.0  // X offset: -left  +right  [of the nozzle]
#define Y_PROBE_OFFSET_FROM_EXTRUDER 6.0  // Y offset: -front +behind [the nozzle]
